export type TPPh4Ayat2CreateFormSchema = {
...
export type TPPh4Ayat2UpdateFormSchema = {
  jenis_penghasilan: string;
  uraian_kegiatan: string;
  no_pengajuan: string;
  target_penerima: string;
...
export type TPPh4Ayat2SingleModel = {
  kode_kegiatan_penghasilan_badan_usaha: string;
  jenis_penghasilan: string;
  uraian_kegiatan: string;
  no_pengajuan: string;
...
export type TPPh4Ayat2ModelPagedResult = {
  result: TPPh4Ayat2SingleModel[];
  current_page: number;
  total_page: number;
  total_count: number;
};

export function toPPh4Ayat2SingleResponse(data: TPPh4Ayat2SingleModel) {
  return {
...
export function toPagedPPh4Ayat2Response(pagedResult: {
  result: TPPh4Ayat2SingleModel[];
  current_page: number;
  total_page: number;
  total_count: number;
  ...
  return {
    result: pagedResult.result.map(toPPh4Ayat2SingleResponse),
